...
const raisedToTheThird = (arr) => arr.map(element => element ** 3);
...
// const charCode = (arr) => {
//   console.log(arr);
//   let charCodeArr = arr.map ( el => el.charCodeAt(0) );
...
const charCode = (arr) => arr.map ( el => el.charCodeAt(0) );
